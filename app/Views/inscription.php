                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-body">
                            <form id="form_register" action="inc/traitement/connexion-inscription" enctype="multipart/form-data" class="needs-validation" style="text-align: center;" method="post">
                                ...
                                <div class="alert alert-success" role="alert">
                                    Votre compte a été creer, vous pouvez vous connectez en <a href="connexion">cliquant ici </a> !
                                </div>
                                <?php endif; ?>
...
<?php $supplies_footer_script = ob_get_contents();
ob_get_clean();
?>